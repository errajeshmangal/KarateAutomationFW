Feature: Validate the Workflow Comments
  ...
  Scenario Outline: Create the comment
    ...
    When method POST
    Then status 201
    And def mongoResult = mongoData.MongoDBReader(dbNameWorkFlow,commentsCollectionName+<tenantid>,entityIdData)
  ...
  Scenario Outline: Create the comment
    ...
    When method POST
    Then status 201
    And def mongoResult = mongoData.MongoDBReader(dbNameWorkFlow,commentsCollectionName+<tenantid>,commentEntityID)
    And print mongoResult
    And match mongoResult == response.body.id
  ...
  Scenario Outline: View the entity comment
    ...
    Then status 200
    And print response
    And def mongoResult = mongoData.MongoDBReader(dbNameWorkFlowRead,commentsCollectionNameRead+<tenantid>,commentEntityID)
    And print mongoResult
  ...
  Scenario Outline: View all the entity comments
    ...
    Then status 200
    And print response
    And def mongoResult = mongoData.MongoDBReader(dbNameWorkFlowRead,commentsCollectionNameRead+<tenantid>,response.results[0].id)
    And print mongoResult
