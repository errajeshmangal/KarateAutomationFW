Feature: Validate the Comments
  ...
  Scenario Outline: Create the comment
    ...
    And def mongoResult = mongoData.MongoDBReader(dbNameWorkWithOrderRead,commentsCollectionName+<tenantid>,entityIdData)
  ...
  Scenario Outline: Update the comment
    ...
    Then status 201
        And sleep(25000)
    And def mongoResult = mongoData.MongoDBReader(dbNameWorkWithOrderRead,commentsCollectionName+<tenantid>,commentEntityID)
    And print mongoResult
    And match mongoResult == response.body.id
  ...
  @GetTheOrderItemInfoEntityComment
  Scenario Outline: View the entity comment
    ...
    Then status 200
    And print response
    And def mongoResult = mongoData.MongoDBReader(dbNameWorkWithOrderRead,commentsCollectionNameRead+<tenantid>,commentEntityID)
    And print mongoResult
  ...
  @GetAllTheOrderItemINfoEntityComments
  Scenario Outline: View all the entity comments
    ...
    Then status 200
    And print response
    And def mongoResult = mongoData.MongoDBReader(dbNameWorkWithOrderRead,commentsCollectionNameRead+<tenantid>,response.results[0].id)
    And print mongoResult
  ...
  @DeleteOrderItemInfoEntityComment
  ...
  @ValidateOrderItemInfoDeleteEntityComment
  ...
  @GetAllTheOrderItemInfoEntityCommentsAfterDelete
  Scenario Outline: View all the entity comments
    Given url readBaseWorkWithOrder
    And path '/api/GetEntityComments'
    And set getCommentsCommandHeader
