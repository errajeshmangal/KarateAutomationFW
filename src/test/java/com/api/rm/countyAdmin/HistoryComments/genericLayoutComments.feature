Feature: Validate the Comments
  ...
  Background: 
    ...
    And def headers = {Accept: 'application/json', Content-Type: 'application/json'}
     And call read('classpath:com/api/rm/helpers/Wait.feature@wait')
      ...
      @CreateGenericLayoutEntityComment
  Scenario Outline: Create the comment
    ...
    Then status 201
  And print response
    And def mongoResult = mongoData.MongoDBReader(dbNameGenericLayout,commentsCollectionName+<tenantid>,entityIdData)
  ...
  @UpdateGenericLayoutEntityComment
  Scenario Outline: Update the comment
    ...
    Then status 201
        And sleep(25000)
    And def mongoResult = mongoData.MongoDBReader(dbNameGenericLayout,commentsCollectionName+<tenantid>,commentEntityID)
    And print mongoResult
    And match mongoResult == response.body.id
  ...
  @GetTheGenericLayoutEntityComment
  Scenario Outline: View the entity comment
    ...
    Then status 200
    And print response
    And def mongoResult = mongoData.MongoDBReader(dbNameGenericLayoutRead,commentsCollectionNameRead+<tenantid>,commentEntityID)
    And print mongoResult
  ...
  @GetTheGenericLayoutEntityComments
  Scenario Outline: View all the entity comments
    ...
    Then status 200
    And print response
    And def mongoResult = mongoData.MongoDBReader(dbNameGenericLayoutRead,commentsCollectionNameRead+<tenantid>,response.results[0].id)
    And print mongoResult
  ...
  @DeleteGenericLayoutEntityComment
  ...
  @ValidateGenericLayoutDeleteEntityComment
  ...
  @GetAllTheGenericLayoutEntityCommentsAfterDelete
  Scenario Outline: View all the entity comments
    Given url readBaseGenericLayout
    And path '/api/GetEntityComments'
    And set getCommentsCommandHeader
